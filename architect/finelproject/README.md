# Система провайдера электронных транспортных накладных.  
...
###  Участник системы:  
- Администратор - сотрудник договорного отдела провайдера. Его задача создавать/редактировать информацию о пользователях системы, и иметь возможность их блокировать/разблокировать.      
