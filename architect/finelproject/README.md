...
Бэкэнд с фронтэндом взаимодействует по средствам REST API.
![Swagger API](https://raw.githubusercontent.com/VadimShtukan/otus_homework/master/architect/finelproject/dock/swagger/api.yaml)

#### -- TODO
1. Общая схема.
1. Взаимодействие с бэкэндом
2. Авторизация пользователей. 
2.1. Межсервисная авторизация. 
2. Описание межсервисного взаимодействия.
3. Диаграмма последовательности по Юзер стори. 
3.1. Структура документов в асинхронном взаимодействии (только ИД, синхронный запрос к доп данным, редис).
4. Паттерн сага
5. Кеширование
