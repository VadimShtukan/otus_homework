package vadim.shtukan.otus.architect.finelproject.EttnGovSender;
...
public class EttnGovSenderApplication {

	public static void main(String[] args) {
		SpringApplication.run(EttnGovSenderApplication.class, args);
	}
